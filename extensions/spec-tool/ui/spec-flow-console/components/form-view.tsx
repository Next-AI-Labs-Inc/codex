...
export function FormView({ settings, onChange }: FormViewProps) {
  ...
  const handleNextAiLabsChange = (key: string, value: any) => {
    onChange({
      ...settings,
      nextAiLabs: {
        ...settings.nextAiLabs,
  ...
  return (
    <div className="space-y-8">
      {/* Swarm Memory Settings */}
      <Card>
        <CardHeader>
          <CardTitle>Swarm Memory Settings</CardTitle>
          <CardDescription>Configure how Next AI Labs captures and guides memory ingest</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={settings.nextAiLabs?.custom_instructions || ""}
              onChange={(e) => handleNextAiLabsChange("custom_instructions", e.target.value)}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 border border-zinc-800 rounded-lg space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Upload a ZIP exported by Next AI Labs tooling. Default settings will be used.</p>
